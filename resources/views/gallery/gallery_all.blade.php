...
<div  class="  col-md-12 " >
  <div class="  col-md-5 "
         ...
         <center id="title" style="height:500px;background-color:white;"><img style="margin-top:10%;border-radius:5%;border:solid white 10px;"class="css" src="{{asset('gallery/images/friend.jpg')}}"/> </center>
       </div>
       <div  class=" col-md-offset-1  col-md-6 col-md-offset-2 "  >
...
@if ($galleries->count() >0)
       ...
       <center>     <h1 style="padding:30px;background-color:#4d3319;border:solid 5px white;color:white">  GalleryZone  </h1> </center>
