        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li ><a href="{{ url('/gallery/list_all') }}" class="active">Friends Gallery</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="background-color:black;color:white;padding:10px;" role="menu">
                                <li ><a href="{{ url('/gallery/list_all') }}" class="active">Friends Gallery</a></li>
                    <li><a href="{{ url('/gallery/list') }}">My Gallery</a></li>
